...
# 
# File downloaded from FTP on 9/1/2021 (via Cyberduck). could  change to save/load with R instead.
...
nc_data <- nc_open(here("data_dl","NOAA_ThermalStress",
...
# Save to text file
sink(here("data", "noaa_thermalstress_info.txt"))
print(nc_data)
sink()
